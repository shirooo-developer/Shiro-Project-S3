...
if (command == 'genjot') {
if (!text) throw `*_Contoh: .genjot Clara_*`
...
if (command == 'nenen') {
if (!text) throw `*_Contoh: .nenen Clara_*`
...
if (command == 'wangy') {
if (!text) throw `*_Contoh: .wangy Clara_*`
...
if (command == 'curhat') {
if (!text) throw `*_Contoh: .curhat Clara_*`
...
if (command == 'perkosa') {
if (!text) throw `*_Contoh: .perkosa Clara_*`
