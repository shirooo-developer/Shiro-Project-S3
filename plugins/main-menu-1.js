...
conn.send3ButtonDoc(m.chat, `\n\n     *Hai, Perkenalkan Aku ⌬ Felicia-MD*\n\n`, intro + `\n ‎\n\n`, '𝗔𝗟𝗟 𝗠𝗘𝗡𝗨', '.? all', '𝗟𝗜𝗦𝗧 𝗠𝗘𝗡𝗨', '.tesm', '𝙍𝘼𝙈𝘼𝘿𝙃𝘼𝙉 𝟮𝟬𝟮𝟯 𝙀𝙑𝙀𝙉𝙏', '.eventlist', m, { contextInfo: { forwardingScore: fsizedoc, externalAdReply: { body: 'Tes', containsAutoReply: true, mediaType: 1, mediaUrl: hwaifu.getRandom(),  renderLargerThumbnail: true, showAdAttribution: true, sourceId: 'Tes', sourceType: 'PDF', previewType: 'PDF', sourceUrl: sgc, thumbnail: fs.readFileSync('./thumbnail.jpg'), thumbnailUrl: sgc, title: '                 𝗜 𝗡 𝗧 𝗥 𝗢 𝗗 𝗨 𝗖 𝗘'}}})
    } 
