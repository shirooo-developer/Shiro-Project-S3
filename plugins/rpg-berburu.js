let handler = async (m, {
	...
	if (new Date - global.db.data.users[m.sender].lastberburu > 500000) {
		...
		let hsl = `
*HUNTING RESULTS ${conn.getName(m.sender)} 🔫*
...
`
      ...
      [null, null]
		...
		setTimeout(() => {
			conn.sendHydrated(m.chat, `*${conn.getName(m.sender)} Hampir Selesai*`, botdate, null, null, null, null, null, [
      [null, null]
    ], null)
		}, 18000)
      ...
      [null, null]
		...
		setTimeout(() => {
			conn.sendHydrated(m.chat, `*${conn.getName(m.sender)} Menemukan Sasaran...*`, botdate, null, null, null, null, null, [
      [null, null]
    ], null)
		}, 14000)
	...
	} else conn.sendButton(m.chat, `\n*Sepertinya Anda Sudah Berburu*\n*Silahkan Istirahat Sekitar* ${timers}\n*Untuk Bisa Melanjutkan Berburu*\n*Cek Hasil Buruan Di #kandang*`, author, null, [
		['Kandang', '.kandang']
	], m)
}
