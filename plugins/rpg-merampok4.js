...
let nomors = m.sender
  ...
  users[m.sender].hoizonglory += 40000
...
handler.help = ['merampok4 *@tag*']
handler.tags = ['rpg']
handler.command = /^merampok4$/
handler.limit = 1
handler.group = true
handler.level = 200
