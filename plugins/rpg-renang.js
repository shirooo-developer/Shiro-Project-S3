...
`.trim()          
            ...
            setTimeout(() => {
                   ...
                   m.reply(`*Kamu Bertanding Renang Dengannya*`)
            ...
            setTimeout(() => {
                   ...
                   m.reply(`*${pickRandom(['Richard Sam Bera', 'Indra Gunawan', 'I Gede Siman Sudartawa', 'Gede Ardika', 'Tauqif Hidayat', 'Fadlan Prawira', 'Gleen Victor Sutanto', 'Triadik Fauzi Sidi','Rafiddias Akhdan Nugroho','Aflah Fadlan Prawira'])} Akan Bertanding Denganmu*`)
...
handler.command = /^(renang)$/i

handler.limit = 1

handler.skillsport = 5
