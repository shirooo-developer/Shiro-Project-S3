let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  let minProfit = value * 0.5 // keuntungan minimal 50% dari nilai investasi
  let maxProfit = value * 1.5 // keuntungan maksimal 150% dari nilai investasi
  ...
  conn.reply(m.chat, `Berhasil melakukan investasi sebesar ${value}. Keuntungan investasi sebesar *********** akan diterima setelah ${clockString(limit)}.`, m)
